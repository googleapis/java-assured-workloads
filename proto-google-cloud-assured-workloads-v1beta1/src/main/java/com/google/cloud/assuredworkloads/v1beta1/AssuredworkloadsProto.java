...
public final class AssuredworkloadsProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "Dgoogle/cloud/assuredworkloads/v1beta1/assuredworkloads_v1beta1.proto\022%google.c"
          ...
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\273\001\n"
          + "\025CreateWorkloadRequest\022@\n"
          + "\006parent\030\001 \001("
          + "\tB0\340A\002\372A*\022(assuredworkloads.googleapis.com/Workload\022F\n"
          + "\010workload\030\002"
          + " \001(\0132/.google.cloud.assuredworkloads.v1beta1.WorkloadB\003\340A\002\022\030\n"
          + "\013external_id\030\003 \001(\tB\003\340A\001\"\225\001\n"
          + "\025UpdateWorkloadRequest\022F\n"
          + "\010workload\030\001"
          + " \001(\0132/.google.cloud.assuredworkloads.v1beta1.WorkloadB\003\340A\002\0224\n"
          ...
          + "\tworkloads\030\001"
          + " \003(\0132/.google.cloud.assuredworkloads.v1beta1.Workload\022\027\n"
          ...
          + "\tresources\030\003"
          + " \003(\0132<.google.cloud.assuredworkloads.v1beta1.Workload.ResourceInfoB\003\340A\003\022c\n"
          + "\021compliance_regime\030\004"
          + " \001(\0162@.google.cloud.assuredworkloads.v1beta1.Workload.ComplianceRegimeB\006\340A\002\340A\005\0227\n"
          + "\013create_time\030\005"
          + " \001(\0132\032.google.protobuf.TimestampB\006\340A\003\340A\005\022\034\n"
          + "\017billing_account\030\006 \001(\tB\003\340A\004\022`\n"
          + "\014il4_settings\030\007"
          + " \001(\0132;.google.cloud.assuredworkloads.v1beta1.Workload.IL4SettingsB\013\030\001\340A\002\340A\004\340A\005H\000\022b\n\r"
          + "cjis_settings\030\010"
          + " \001(\0132<.google.cloud.assuredworkloads.v1beta1.Workload.CJISSettingsB\013\030\001\340A\002\340A\004\340A\005H\000\022q\n"
          + "\025fedramp_high_settings\030\013"
          + " \001(\0132C.google.cloud.assuredworkloads.v1beta1.Workload.FedrampHighSettingsB\013\030\001\340A\002\340A\004\340A\005H\000\022y\n"
          + "\031fedramp_moderate_settings\030\014"
          + " \001(\0132G.google.cloud.assuredworkloads.v1beta1.Workload.FedrampModerateSettingsB\013\030\001\340A\002\340A\004\340A\005H\000\022\021\n"
          + "\004etag\030\t \001(\tB\003\340A\001\022P\n"
          + "\006labels\030\n"
          + " \003(\0132;.google.cloud.assuredworkloads.v1beta1.Workload.LabelsEntryB\003\340A\001\022)\n"
          + "\034provisioned_resources_parent\030\r"
          + " \001(\tB\003\340A\004\022V\n"
          + "\014kms_settings\030\016"
          + " \001(\0132;.google.cloud.assuredworkloads.v1beta1.Workload.KMSSettingsB\003\340A\004\022`\n"
          + "\021resource_settings\030\017"
          + " \003(\0132@.google.cloud.assuredworkloads.v1beta1.Workload.ResourceSettingsB\003\340A\004\032\216\002\n"
          + "\014ResourceInfo\022\023\n"
          + "\013resource_id\030\001 \001(\003\022`\n\r"
          + "resource_type\030\002"
          + " \001(\0162I.google.cloud.assuredworkloads.v1beta1.Workload.ResourceInfo.ResourceType\"\206\001\n"
          ...
          + "\t\340A\002\340A\004\340A\005\032o\n"
          + "\013IL4Settings\022\\\n"
          + "\014kms_settings\030\001 \001(\0132;.google.cloud."
          + "assuredworkloads.v1beta1.Workload.KMSSettingsB"
          + "\t\340A\002\340A\004\340A\005:\002\030\001\032p\n"
          + "\014CJISSettings\022\\\n"
          + "\014kms_settings\030\001 \001(\0132;.google.cloud.assure"
          ...
          + "edworkloads.v1beta1.Workload.KMSSettingsB"
          + "\t\340A\002\340A\004\340A\005:\002\030\001\032{\n"
          + "\027FedrampModerateSettings\022\\\n"
          + "\014kms_settings\030\001 \001(\0132;.google.cloud."
          + "assuredworkloads.v1beta1.Workload.KMSSettingsB"
          + "\t\340A\002\340A\004\340A\005:\002\030\001\032\237\001\n"
          + "\020ResourceSettings\022\023\n"
          + "\013resource_id\030\001 \001(\t\022`\n\r"
          + "resource_type\030\002"
          + " \001(\0162I.google.cloud.assuredworkloads.v1beta1.Workload.ResourceInfo.ResourceType\022\024\n"
          ...
          + "(assuredworkloads.googleapis.com/Workload\022Forganizations/{organization}/locations/{location}/workloads/{workload}B\034\n"
          ...
          + "\021compliance_regime\030\004"
          + " \001(\0162@.google.cloud.assuredworkloads.v1beta1.Workload.ComplianceRegimeB\003\340A\001\022`\n"
          + "\021resource_settings\030\005"
          + " \003(\0132@.google.cloud.assuredworkloads.v1beta1.Workload.ResourceSettingsB\003\340A\0012\243"
          + "\t\n"
          + "\027AssuredWorkloadsService\022\371\001\n"
          + "\016CreateWorkload\022<.google.cloud.assuredworkloads.v1beta1.CreateWorkloadRequest\032\035.google.longrunning.Operation\"\211\001\202\323\344\223\002C\"7/v1beta1/{parent=organizations/*/locations/*}/workloads:\010workload\332A\017parent,workload\312A+\n"
          + "\010Workload\022\037CreateWorkloadOperationMetadata\022\352\001\n"
          + "\016UpdateWorkload\022<.google.cloud.assuredworkloads.v1beta1.UpdateWor"
          + "kloadRequest\032/.google.cloud.assuredworkloads.v1beta1.Workload\"i\202\323\344\223\002L2@/v1beta1/{workload.name=organizations/*/locations/*/workloads/*}:\010workload\332A\024workload,update_mask\022\256\001\n"
          + "\016DeleteWorkload\022<.google.cloud.assuredworkloads.v1beta1.DeleteWorkloadRequest\032\026.google.protobuf.Empty\"F\202\323\344\223\0029*7/v1beta1/{name=organizations/*/locations/*/workloads/*}\332A\004name\022\301\001\n"
          + "\013GetWorkload\0229.google.cloud.assuredworkloads.v1beta1.GetWorkloadRequest\032/.google.cloud.assuredworkloads.v1beta1.Workload\"F\202\323\344\223\0029\0227/v1beta1/{name=organizations/*/locations/*/workloads/*}\332A\004name\022\324\001\n\r"
          + "ListWorkloads\022;.google.cloud.assuredworkloads.v1beta1."
          + "ListWorkloadsRequest\032<.google.cloud.assuredworkloads.v1beta1.ListWorkloadsRespon"
          + "se\"H\202\323\344\223\0029\0227/v1beta1/{parent=organizations/*/locations/*}/workloads\332A\006parent\032S\312A\037assuredworkloads.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\366\002\n"
          + ")com.google.cloud.assuredworkloads.v1beta1B\025AssuredworkloadsProtoP\001ZUgoogle"
          + ".golang.org/genproto/googleapis/cloud/assuredworkloads/v1beta1;assuredworkloads\252\002%Google.Cloud.AssuredWorkloads.V1Beta1\312\002%Google\\Cloud\\AssuredWorkloads\\V1beta1\352\002(Google::Cloud::AssuredWorkloads::V1beta1\352A]\n"
          + "(assuredworkloads.googleapis.com/Location\0221organizations/{organization}/lo"
